...
import NewsPreview2 from './newsPreview2'
    ...
    render() {
        return (
            <div>
                ...
                {/* <Subnav items=
                {[{text: 'آخرین‌ها', url: '#', isDroppedDown: false, dropDownItems: [], isActive: true}, {text: 'آخرین‌ها', url: '#', isDroppedDown: false, dropDownItems: [], isActive: false}, {text: 'مورد علاقه', url: '#', isDroppedDown: true, dropDownItems: ['ahmad', 'zoghi'], isActive: false}]} /> */}

                <Subnav items={[{text: 'آخرین‌ها', url: '#', isDroppedDown: false, dropDownItems: [], isActive: true}, {text: 'مورد علاقه', url: '#', isDroppedDown: false, dropDownItems: [], isActive: false}]} />

                <div class="main-container">
                    {/* <div>
                        <p style={{width :'70%', margin: 'auto', fontSize: '30px', textAlign: 'center'}}>فوتبال</p>
                        <NewsPreview/>
                        <p style={{width :'70%', margin: 'auto', fontSize: '30px', textAlign: 'center'}}>بسکتبال</p>
                        <NewsPreview2/>
                    </div> */}
