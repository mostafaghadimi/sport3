    ...
    render() {
        return (
            <div>
                ...
                <Subnav items=
                {[{text: 'سلام', url: '#', isDroppedDown: false, dropDownItems: [], isActive: true}, {text: 'عرض', url: '#', isDroppedDown: false, dropDownItems: [], isActive: false}, {text: 'ادب', url: '#', isDroppedDown: true, dropDownItems: ['ahmad', 'zoghi'], isActive: false}]} />
