        ...
        return (
            ...
            <div class="container">
                <div class="tournament-bracket tournament-bracket--rounded">                                                     
                    ...
                    <h3 class="tournament-bracket__round-title">یک‌چهارم</h3>
                    <ul class="tournament-bracket__list">
                        <li class="tournament-bracket__item">
                        <div class="tournament-bracket__match" tabindex="0">
                            <table class="tournament-bracket__table">
                            <caption class="tournament-bracket__caption">
                                <time datetime="2018-02-18">18 February 2018</time>
                            </caption>
                            <thead class="sr-only">
                                <tr>
                                <th>Country</th>
                    ...
                    <h3 class="tournament-bracket__round-title">نیمه نهایی</h3>
                    <ul class="tournament-bracket__list">
                        <li class="tournament-bracket__item">
                        <div class="tournament-bracket__match" tabindex="0">
                            <table class="tournament-bracket__table">
                    ...
                    <h3 class="tournament-bracket__round-title">رده‌بندی</h3>
                    <ul class="tournament-bracket__list">
                        <li class="tournament-bracket__item">
                        <div class="tournament-bracket__match" tabindex="0">
                            <table class="tournament-bracket__table">
                    ...
                    <h3 class="tournament-bracket__round-title">فینال</h3>
                    <ul class="tournament-bracket__list">
                        <li class="tournament-bracket__item">
                        <div class="tournament-bracket__match" tabindex="0">
                            <table class="tournament-bracket__table">
                            <caption class="tournament-bracket__caption">
                                <time datetime="2018-02-22">22 February 2018</time>
                            </caption>
                            <thead class="sr-only">
                                <tr>
                                <th>Country</th>
